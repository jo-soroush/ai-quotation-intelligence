...
NOT_OBSERVED_FOR_THIS_CARD — implementation is intentionally uncommitted; runtime Git state is queried from Git.
...
NOT_COMPLETE — implementation and validation are ready, but Git delivery and post-delivery reconciliation remain required.
...
| V1-C03 | Synthetic Historical Data | READY_FOR_DELIVERY | YES | PASS | PROVEN | PASS | PRESENT | READY_FOR_DELIVERY |
...
V1-C01: COMPLETE
V1-C02: COMPLETE
V1-C03: READY_FOR_DELIVERY
V1-C04: NOT_AUTHORIZED / NOT_STARTED
Active Card: V1-C03
